      ...
      <form className="profile__form" onSubmit={handleSubmit}>
        ...
        <div className="profile__fields">
          <div className="profile__field">
            ...
            ></input>
            <span className={`profile__error ${errors.name ? "profile__error_visible" : "profile__error"}`}>{errors.name}</span>
          </div>
          <div className="profile__field">
            ...
            <input
              ...
              placeholder="Email"
            ></input>
            <span className={`profile__error ${errors.email ? "profile__error_visible" : "profile__error"}`}>{errors.email}</span>
          </div>
        </div>
